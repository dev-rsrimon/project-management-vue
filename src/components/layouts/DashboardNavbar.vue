<template>
    <div class="d-navbar">
        <div class="d-navbar__logo">
            <img :src="require(`@/assets/images/${logo}`)" class="tork-img-fluid" alt="Logo">
        </div>
        <ul class="d-navbar___links">
            <li class="d-navbar__link">
                <div class="d-navbar__link-icon">
            ...
            <li class="d-navbar__link">
                ...
                <router-link to="/">Time Manage</router-link>
            </li>
            <li class="d-navbar__link">
                <div class="d-navbar__link-icon">
